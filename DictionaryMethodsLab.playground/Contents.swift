...
// print(starWarsVillains) to check.
 ...
 */
for (keys,characterType) in starWarsCharacters{
    print("\(keys) \(characterType)")
}
...
// I expect to see: "There are 4 items in the dictionary." 4 keys.
...
starWarsCharacters["Jedi"]?.append("Aayla Secura")
